...
public class LoggerFrame extends JFrame {
	  ...
	  public LoggerFrame() {
	    ...
	    lblResultValue = new JLabel("Por favor oprima el botón ESCRIBIR MENSAJE para registrarlo en la salida seleccionada");
...
class ButtonHandler implements ActionListener {
  ...
  String outputType = objLoggerFrame.getOutputType();
	      if (outputType=="ARCHIVO") {
	    	  ...
	    	  logger.log(message);
	          Result = 
	  		  " El mensaje fue escrito exitosamente en archivo";

	        } else {
	          Logger logger= ConsoleLogger.getConsoleLogger();
	          logger.log(message);
	        	Result = 
	            "El mensaje fue escrito exitosamente en consola";

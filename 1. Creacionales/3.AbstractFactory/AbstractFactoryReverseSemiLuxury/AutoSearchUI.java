...
public class AutoSearchUI extends JFrame {
  ...
  public static final String SEMILUXURY = "Semi-Luxury";
  ...
  public AutoSearchUI() {
    ...
    cmbVehicleCategory.addItem(AutoSearchUI.SEMILUXURY);
...
class ButtonHandler implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getActionCommand().equals(AutoSearchUI.SEARCH)) {
      ...
      if (vhCategory.equals(AutoSearchUI.SEMILUXURY)) {
        SemiLuxury s = vf.getSemiLuxury();
        searchResult =
                "Name: " + s.getSLName() + "  Features: " + s.getSLFeatures();
      }
